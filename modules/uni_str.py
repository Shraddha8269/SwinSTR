...
layer_scale = False
init_value = 1e-6
def create_unistr(num_tokens, model=None, checkpoint_path=''):
    unistr = create_model(
        model,
        pretrained=True,
    ...
    unistr.reset_classifier(num_classes=num_tokens)
...
def uniformer_small(pretrained=True, **kwargs):
    ...
    model.default_cfg = _cfg(url="https://github.com/Shraddha8269/SwinSTR/releases/download/v1.0.0/uniformer_small_in1k.pth")
    if pretrained:
        load_pretrained(
